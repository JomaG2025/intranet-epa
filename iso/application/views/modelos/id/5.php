                            ...
                            <div class="row">
                                <?php if($this->session->userdata('full') OR ($this->uri->segment(3) == 'full')){ ?>
                                <div class="col-md-12">
                        			<img src="<?= base_url(); ?>img/mapa.png" alt="" class="img-responsive" usemap="#image-map-2019-full" />
                                    <map name="image-map-2019-full">
                                        ...
                                        <!-- Auditoría y Apoyo Legal habilitado -->
                                        <area href="<?= site_url('modelos/proceso/114'); ?>" coords="1233,1089,1413,1192" shape="rect">
                            ...
                            <div class="modal fade" id="modal-sub-03" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img src="<?= base_url(); ?>img/sub_03_2019_v4.png" alt="" class="img-responsive" usemap="#image-map-sub-03" />

                                            <map name="image-map-sub-03">
                                                <area href="<?= site_url('modelos/proceso/109'); ?>" coords="42,265,363,444" shape="rect">
                                                <area href="<?= site_url('modelos/proceso/110'); ?>" coords="394,265,714,445" shape="rect">
                                                <area href="<?= site_url('modelos/proceso/111'); ?>" coords="749,265,1067,445" shape="rect">
                                                <area href="<?= site_url('modelos/proceso/112'); ?>" coords="1105,265,1430,445" shape="rect">
                                                <area href="<?= site_url('modelos/proceso/114'); ?>" coords="1470,265,1784,444" shape="rect">
                                                <area href="<?= site_url('modelos/proceso/113'); ?>" coords="1819,265,2128,445" shape="rect">
                                            </map>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
