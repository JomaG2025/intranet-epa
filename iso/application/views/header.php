...
<head>
    ...
    <script src="<?= base_url(); ?>js/plugins/imageMapResizer/imageMapResizer.js"></script>
		...
		<nav class="navbar navbar-default navbar-fixed-top">
	        ...
	        <div class="navbar-header">
	            ...
	            <a class="navbar-brand" href="<?= site_url(''); ?>">
			        <i class="fa fa-sitemap"></i> Sistemas de Gestión
			    </a>
	        </div>
	        ...
	        <div class="collapse navbar-collapse navbar-ex1-collapse">
		    	...
		    	<ul class="nav navbar-nav side-nav">
	            	...
	            	<li class="<?= (( ! $this->uri->segment(1)) OR ($this->uri->segment(1) == 'modelos')) ? 'active': ''; ?>"><a href="<?= site_url(''); ?>"><i class="fa fa-sitemap"></i> Modelos</a></li>
	            	...
	            	<li class="dropdown <?= ($this->uri->segment(1) == 'admin') ? 'active open': ''; ?>">
		            	...
		            	<ul class="dropdown-menu">
			            	<li><a href="<?= site_url('admin/modelos'); ?>">Modelos</a></li>
			            	<li><a href="<?= site_url('admin/grupos'); ?>">Grupos</a></li>
			            	<li><a href="<?= site_url('admin/procesos'); ?>">Procesos</a></li>
