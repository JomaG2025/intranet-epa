				...
				<div class="panel-body">
			        ...
			        <div class="row">
			        	...
			        	<div class="col-lg-12">
							  ...
							  <form method="post" action="<?= site_url('admin/procesos/grabar'); ?>" enctype="multipart/form-data">
										    ...
										    <div class="col-md-6">	
												...
												<div class="row">
													...
													<div class="form-group col-md-6">
														<label>Código</label>
														<input type="text" name="codigo" maxlength="8" class="form-control" autocomplete="off"/>
													</div>
													<div class="form-group col-md-6">
														<label>Grupo</label>
														<select name="grupo" class="form-control">
														<?php foreach($grupos as $grupo){ ?>
															<option value="<?= $grupo['id']; ?>"><?= $grupo['modelo_nombre'] ?> - <?= $grupo['nombre']; ?></option>
														<?php } ?>
													</select>
													</div>
