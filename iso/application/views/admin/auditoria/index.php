					...
					<form id="form-filtros" action="<?= site_url('admin/auditoria') ?>" method="get">
				    	...
				    	<div class="row">
				    		...
				    		<div class="form-group col-md-2 col-xs-6">
				    			...
				    			<div class="radio">
				    				<label>
				    					<input type="radio" name="filtro" value="periodo" id="radio-periodo">
				    					Periodo
				    				</label>
				    			</div>				        				
				    			<select name="periodo" class="form-control" id="filtro-periodo">
				    				<?php foreach($anos as $ano){ ?>
										<option value="<?= $ano['ano']; ?>-01">Enero <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-02">Febrero <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-03">Marzo <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-04">Abril <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-05">Mayo <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-06">Junio <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-07">Julio <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-08">Agosto <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-09">Septiembre <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-10">Octubre <?= $ano['ano']; ?></option>
										<option value="<?= $ano['ano']; ?>-11">Noviembre <?= $ano['ano']; ?></option>
				    					<option value="<?= $ano['ano']; ?>-12">Diciembre <?= $ano['ano']; ?></option>
				    				<?php } ?>
				    			</select>
            ...
            <script>
                ...
                $(function(){
                    ...
                    $('#filtro-periodo').attr('disabled', 'disabled');
                    ...
                    <?php
                            ...
                            case 'periodo':
                    ?>
                            $('#radio-periodo').prop('checked', true);
                            $('#filtro-desde').attr('disabled', 'disabled');
                            $('#filtro-hasta').attr('disabled', 'disabled');
                            $('#filtro-dia').attr('disabled', 'disabled');
                            $('#filtro-periodo').removeAttr('disabled').val('<?= $valor; ?>');
                    <?php
                            break;
                    ...
                    $('#radio-periodo').change(function(e)
                    {
                        if($(e.currentTarget).prop('checked'))
                        {
                            $('#filtro-desde').attr('disabled', 'disabled').val('');
                            $('#filtro-hasta').attr('disabled', 'disabled').val('');
                            $('#filtro-dia').attr('disabled', 'disabled').val('');
                            $('#filtro-periodo').removeAttr('disabled');
                        }
                    });
