...
<html lang="es">
<head>
    <title>Módulo Relacionados</title>
		...
		<nav class="navbar navbar-default navbar-fixed-top">
	        ...
	        <div class="navbar-header">
	            ...
	            <a class="navbar-brand" href="<?= site_url(); ?>">
			        <i class="fa fa-users"></i> Relacionados
			    </a>
	        </div>
	        ...
	        <div class="collapse navbar-collapse navbar-ex1-collapse">
		    	...
		    	<ul class="nav navbar-nav side-nav">
	            	...
	            	<li class="<?= ((!$this->uri->segment(1)) OR ($this->uri->segment(1) == 'relacionados')) ? 'active': ''; ?>"><a href="<?= site_url('relacionados'); ?>"><i class="fa fa-users"></i> Relacionados</a></li>
