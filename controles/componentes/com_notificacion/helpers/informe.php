<?php define('DIRECT_ACCESS', true);
  ...
  //ini_set('display_errors', '1');
    ...
    $controles = Notificacion::informe();
    $usuarios = array();
    ...
    foreach($usuarios as $usuario)
    {
        ...
        $asunto = 'Informe semanal de Controles';
                                              ...
                                              <tbody>
                                                <tr style="padding: 0; text-align: left; vertical-align: top;">
                                                  <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                                    <p class="text-right" style="Margin: 0; Margin-bottom: 10px; color: #fff; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; padding-top: 15px; text-align: right;">CONTROL Y ALERTAS</p>
                                                  </th>
                                                </tr>
                                              </tbody>
                                            </table>
                                  ...
                                  <th class="small-12 large-12 columns first last" style="Margin: 0 auto; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0 auto; padding: 0; padding-bottom: 16px; padding-left: 16px; padding-right: 16px; text-align: left; width: 564px;">
                                    <table style="border-collapse: collapse; border-spacing: 0; padding: 0; text-align: left; vertical-align: top; width: 100%;">
                                      <tbody>
                                        <tr style="padding: 0; text-align: left; vertical-align: top;">
                                          <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                            <h1 style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 34px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left; word-wrap: normal;">Informe semanal de Controles</h1>
                                            <p style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left;">'. (($usuario['sexo'] == 'M') ? 'Estimado' : 'Estimada').' <strong>' . utf8_decode($usuario['nombre'])  .'</strong>, a continuación se presenta el detalle semanal de los Controles atrasados y próximos a cumplir la fecha comprometida según los plazos establecidos en el Sistema de Control y alertas.</p>
                                            <br>
...
<tbody>';
        ...
        foreach($usuario as $key => $control)
        {
           ...
           $cuerpo .= '<tr style="background: #B2DFF5;">
            ...
            <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; text-align: center; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">'.  $array_estados[$control['estado']]  .'</td>
</tr>';
