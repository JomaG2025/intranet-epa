<div class="titulo">
    <h1>{$SISTEMA_TITULO} <a href="{$REFERER}" title="volver"><img src="template/imagenes/volver.png" alt="volver" id="volver" /></a></h1>
</div>
<div id="content">
...
<textarea cols="10" rows="10" name="descripcion" class="no-validar">{$grupo.descripcion}</textarea>
<div class="clear"></div>
