		...
		<nav class="navbar navbar-default navbar-fixed-top">
	        ...
	        <div class="navbar-header">
	            ...
	            <a class="navbar-brand" href="<?= site_url(''); ?>">
			        <i class="fa fa-briefcase"></i> Garantías
			    </a>
	        </div>
	        ...
	        <div class="collapse navbar-collapse navbar-ex1-collapse">
		    	...
		    	<ul class="nav navbar-nav side-nav">
                    ...
                    <li class="dropdown <?= ($this->uri->segment(1) == 'garantias') ? 'active open': ''; ?>">
		            	<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-briefcase"></i> Garantías &nbsp;<i class="fa fa-caret-down"></i></a>
		            	<ul class="dropdown-menu">
			            	<li><a href="<?= site_url('garantias'); ?>">Todas las Garantías</a></li>
			            	<li><a href="<?= site_url('garantias/alertadas'); ?>">Alertadas</a></li>
			            	<li><a href="<?= site_url('garantias/vencidas'); ?>">Vencidas</a></li>
			            	<li><a href="<?= site_url('garantias/devueltas'); ?>">Devueltas</a></li>
			            	<li><a href="<?= site_url('garantias/cobradas'); ?>">Cobradas</a></li>
			            </ul>
			        </li>
                    <li class="dropdown <?= ($this->uri->segment(1) == 'reporte') ? 'active open': ''; ?>">
		            	...
		            	<ul class="dropdown-menu">
			            	<li><a href="<?= site_url('reporte/ingresadas'); ?>">Garantías ingresadas</a></li>
			            	<li><a href="<?= site_url('reporte/vigentes'); ?>">Vigentes</a></li>
			            	<li><a href="<?= site_url('reporte/vencidas'); ?>">Vencidas</a></li>
			            	<li><a href="<?= site_url('reporte/devueltas'); ?>">Devueltas</a></li>
			            	<li><a href="<?= site_url('reporte/cobradas'); ?>">Cobradas</a></li>
			            </ul>
			        </li>
