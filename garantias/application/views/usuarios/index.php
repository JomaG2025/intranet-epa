			...
			<div class="navbar-action hidden-xs">
			    <a href="<?= site_url('usuarios/nuevo'); ?>" class="btn btn-info" title="Nuevo"><i class="fa fa-plus"></i> Nuevo Usuario</a>
			</div>	
        	...
        	<div class="panel panel-default no-border">
				<div class="panel-heading visible-xs"><i class="fa fa-cogs"></i> Usuarios<a href="<?= site_url('usuarios/nuevo'); ?>" class="btn btn-info btn-xs pull-right" title="Nuevo"><i class="fa fa-plus"></i> Nuevo Usuario</a></div>
