                                      ...
                                      <tbody>
                                        <tr style="padding: 0; text-align: left; vertical-align: top;">
                                          <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                            <p class="text-right" style="Margin: 0; Margin-bottom: 10px; color: #fff; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; padding-top: 15px; text-align: right;">GARANTÍAS</p>
                                          </th>
                                        </tr>
                                      </tbody>
                                    </table>
                          ...
                          <th class="small-12 large-12 columns first last" style="Margin: 0 auto; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0 auto; padding: 0; padding-bottom: 16px; padding-left: 16px; padding-right: 16px; text-align: left; width: 564px;">
                            <table style="border-collapse: collapse; border-spacing: 0; padding: 0; text-align: left; vertical-align: top; width: 100%;">
                              <tbody>
                                <tr style="padding: 0; text-align: left; vertical-align: top;">
                                  <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                    <h1 style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 34px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left; word-wrap: normal;">Informe semanal de Garantías alertadas</h1>
                                    <p style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left;"><?= (($usuario['sexo'] == 'M') ? 'Estimado' : 'Estimada'); ?> <strong><?= $usuario['nombre']; ?></strong>, a continuación se presenta el detalle de las Garantías al día de hoy se encuentran Alertadas y/o Vencidas, según la información y plazos registrados en el Módulo de Control de Garantías Proveedores.</p>
                                    <br>
                                  </th>
                                  ...
                                  <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                    ...
                                    <table style="border-collapse: collapse; width: 100%;">
                                        ...
                                        <?php if($vencidas){ ?>
                                            ...
                                            <?php foreach($vencidas as $garantia){ ?>
                                                ...
                                                <tr style="background: #B2DFF5;">
                                                    ...
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: center; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                                        <?= formato_monto($garantia['proveedor']); ?>-<?= $garantia['proveedor_dv']; ?>
                                                    </td>
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: center; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                                        <?= $garantia['proveedor_razon']; ?>
                                                    </td>
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: center; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                                        <?= $garantia['inicio']; ?>
                                                    </td>
                                        ...
                                        <?php if($alertadas){ ?>
                                            ...
                                            <?php foreach($alertadas as $garantia){ ?>
