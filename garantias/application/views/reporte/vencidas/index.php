			<div class="navbar-title hidden-xs">
			    <h4><i class="fa fa-angle-right"></i> Reportes <i class="fa fa-angle-right"></i> Garantías vencidas</h4>
			</div>
            <div class="navbar-action hidden-xs">
				<a href="<?= site_url('reporte/vencidas/imprimir'); ?>" target="_blank" class="btn btn-info <?= (empty($reportes)) ? 'disabled' : ''; ?>"><i class="fa fa-download"></i> Generar Excel</a> 
			</div>
        	<div class="panel panel-default no-border">
				<div class="panel-heading visible-xs"><i class="fa fa-cogs"></i> Garantías vencidas</div>
