...
class Cobradas extends CI_Controller {
	...
	{
		$data['reportes'] = $this->reporte->listar_cobradas();	

		$this->load->view('header');
		$this->load->view('reporte/cobradas/index', $data);
    ...
    public function imprimir()
	{
		...
		$titulo = 'Reporte de Garantias cobradas';
        $reportes = $this->reporte->listar_cobradas();
		...
		$this->excel->getActiveSheet()->setTitle('Garantias cobradas');
...
/* End of file cobradas.php */
/* Location: ./application/controllers/reporte/cobradas.php */