...
class Devueltas extends CI_Controller {
	...
	{
		$data['reportes'] = $this->reporte->listar_devueltas();	

		$this->load->view('header');
		$this->load->view('reporte/devueltas/index', $data);
    ...
    public function imprimir()
	{
		...
		$titulo = 'Reporte de Garantias devueltas al Proveedor';
        $reportes = $this->reporte->listar_devueltas();
		...
		$this->excel->getActiveSheet()->setTitle('Garantias devueltas');
...
/* End of file devueltas.php */
/* Location: ./application/controllers/reporte/devueltas.php */