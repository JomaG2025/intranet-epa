...
class Vencidas extends CI_Controller {
	...
	{
        $data['reportes'] = $this->reporte->listar_vencidas();

		$this->load->view('header');
		$this->load->view('reporte/vencidas/index', $data);
    ...
    public function imprimir()
	{
        ...
        $titulo = 'Reporte de Garantias vencidas';
        $reportes = $this->reporte->listar_vencidas();
		...
		$this->excel->getActiveSheet()->setTitle('Garantias vencidas');
...
/* End of file vencidas.php */
/* Location: ./application/controllers/reporte/vencidas.php */