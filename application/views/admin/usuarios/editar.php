								        ...
								        <div class="col-md-6">
                                            <div class="row">							    
											     <div class="form-group col-sm-6">
                                                     <label>Usuario</label>
                                                     <input name="usuario" type="text" value="<?= $usuario['usuario'] ?>" class="form-control" maxlength="32" disabled autocomplete="off">
                                                </div>
                                                <div class="form-group col-sm-6">
												    <label>E-mail</label>
												    <input name="email" type="email" value="<?= $usuario['email'] ?>" class="form-control" placeholder="nombre@puertoarica.cl" maxlength="32" autocomplete="off">
                                                </div>
								            </div>
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input name="nombre" type="text" class="form-control" value="<?= $usuario['nombre'] ?>" placeholder="Nombre" maxlength="32" required autocomplete="off">
                                            </div>
                                            <div class="form-group">
                                                <label>Cargo</label>
                                                <input name="cargo" type="text" class="form-control" value="<?= $usuario['cargo'] ?>" placeholder="Cargo" maxlength="64" autocomplete="off">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="form-group col-sm-6">
												    ...
												    <div class="row">
                                                        <div class="col-xs-9">
                                                            <input type="text" value="<?= $usuario['rut']; ?>" maxlength="8" name="rut" class="form-control" />
                                                        </div>
                                                        <div class="col-xs-3">
                                                            <input type="text" value="<?= $usuario['dv']; ?>" maxlength="1" name="dv" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group col-sm-6">
										      	...
										      	<div class="form-group col-sm-6">
													...
													<select name="privilegio" class="form-control">
														<?php foreach($privilegios as $privilegio){ ?>
															<option value="<?= $privilegio['abrev'] ?>" <?= ($privilegio['abrev'] == $usuario['privilegio']) ? 'selected="selected"' : ''; ?> ><?= $privilegio['nombre']; ?></option>
														<?php } ?>
													</select>
												</div>
												<div class="form-group col-sm-6">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="primer_inicio" value="0" <?= ( ! $usuario['primer_inicio']) ? 'checked' : ''; ?> /> No
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="primer_inicio" value="1" <?= ($usuario['primer_inicio']) ? 'checked' : ''; ?> /> Si
                                                    </label>
												</div>
                                            </div>
											<div class="row">
