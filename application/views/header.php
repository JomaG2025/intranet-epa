...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url(); ?>css/plugins/zabuto_calendar/zabuto_calendar.min.css">
    ...
    <script src="<?= base_url(); ?>js/plugins/zabuto_calendar/zabuto_calendar.min.js"></script>
...
<body>
	...
	<div class="modal fade autofocus" id="modal-perfil" tabindex="-1" role="dialog" aria-hidden="true">
				    	...
				    	<div class="row">
			    			...
			    			<div class="form-group col-md-6">
			    				...
			    				<div class="input-group">
				    				<input type="password" name="password" maxlength="64" class="form-control" pattern="[a-zA-Z0-9]{8,}" required/>
		...
		<nav class="navbar navbar-default navbar-fixed-top">
	        ...
	        <div class="navbar-header">
	            ...
	            <a class="navbar-brand" href="<?= site_url(); ?>">
			        <i class="fa fa-globe fa-lg"></i> Intranet EPA
			    </a>
	        </div>
	        ...
	        <div class="collapse navbar-collapse navbar-ex1-collapse">
		    	...
		    	<ul class="nav navbar-nav side-nav">
	            	...
	            	<li class="<?= ($this->uri->segment(1) == 'auditoriainterna') ? 'active' : ''; ?>"><a href="<?= site_url('auditoriainterna'); ?>"><i class="fa fa-list-alt"></i> Auditoría interna</a></li>
			        ...
			        <li><a href="#modal-perfil" data-toggle="modal"><i class="fa fa-lock"></i> Cambiar contraseña</a></li>
