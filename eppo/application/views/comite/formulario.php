            <div class="navbar-title hidden-xs">
			    <h4><i class="fa fa-angle-right"></i> Comité de evaluación Periodo <?= $periodo_actual['periodo']; ?> <i class="fa fa-angle-right"></i> <?= $formulario['nombre']; ?></h4>
			</div>

            <div class="navbar-action hidden-xs">
			    <a href="<?= site_url('comite'); ?>" class="btn btn-default"><i class="fa fa-angle-left"></i> Volver</a>
			</div>	
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default no-border">
                        ...
                        <div class="panel-heading visible-xs"><a href="<?= site_url('comite'); ?>" class="btn btn-info btn-xs pull-right"><i class="fa fa-angle-left"></i> Volver</a></div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="well text-center mb-40">
                                ...
                                <?php if($formulario['estadoformulario'] == 'APE'){ ?>
                                <a href="#resultado-apelacion" class="btn btn-info"><i class="fa fa-check"></i> Resolver apelación</a>
                                <?php } ?>
                                
                            </div>

                            <form action="<?= site_url('comite/apelacion'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <?php if(($formulario['estadoformulario'] == 'APE') OR (($formulario['estadoformulario'] == 'EVA') AND $resultadoapelacion)){ ?>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-5 col-sm-8">
											...
											<div class="form-group">
                                                <textarea class="form-control" rows="5" name="resultadoapelacion[observacion]" placeholder="Resultado de la apelación" required <?= ($formulario['estadoformulario'] == 'EVA') ? 'readonly' : ''; ?>><?= $resultadoapelacion['observacion']; ?></textarea>
                                            </div>
                                        ...
                                        <div class="col-lg-2 col-md-3 col-sm-4">
											...
											<div class="form-group">
                                                <h5 class="mt-0">Evaluación</h5>
                                                <div class="input-group">
                                                    <input type="number" class="form-control input-lg" name="resultadoapelacion[puntaje]" min="<?= $rango['minimo']; ?>" max="<?= $rango['maximo']; ?>" value="<?= ($resultadoapelacion['puntaje']) ? $resultadoapelacion['puntaje'] : $resultado['puntaje']; ?>" <?= ($formulario['estadoformulario'] == 'EVA') ? 'readonly' : ''; ?> required/>
                                ...
                                <fieldset class="mt-40 mb-40">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-offset-4 col-md-offset-2 col-lg-2 col-md-4">
                                            <a href="<?= site_url('comite'); ?>" class="btn btn-lg btn-default btn-block btn-cancelar submit"><i class="fa fa-times"></i> Cancelar</a>
                                        </div>
                                        <p class="visible-xs visible-sm"></p>
                                        <div class="col-lg-2 col-md-4">
                                            <input type="hidden" name="formulario" value="<?= $formulario['id']; ?>" />
                                            <button type="submit" class="btn btn-block btn-info btn-lg"><i class="fa fa-check"></i> Resolver apelación</button>   
                                        </div>
                                        
                                        <?php }else{ ?>
                                        
                                        <div class="col-lg-offset-5 col-md-offset-4 col-lg-2 col-md-4">
                                            <a href="<?= site_url('comite'); ?>" class="btn btn-lg btn-default btn-block btn-cancelar"><i class="fa fa-times"></i> Cancelar</a>
                                        </div>
