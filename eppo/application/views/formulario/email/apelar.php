                          ...
                          <th class="small-12 large-12 columns first last" style="Margin: 0 auto; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0 auto; padding: 0; padding-bottom: 16px; padding-left: 16px; padding-right: 16px; text-align: left; width: 564px;">
                            <table style="border-collapse: collapse; border-spacing: 0; padding: 0; text-align: left; vertical-align: top; width: 100%;">
                              <tbody>
                                <tr style="padding: 0; text-align: left; vertical-align: top;">
                                  <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                    <h1 style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 34px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left; word-wrap: normal;"><?= $evaluado['nombre'] ?> ha solicitado la apelación de su Formulario EPPO <?= $periodo['periodo']; ?></h1>
                                    <p style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left;"><?= (($evaluador['sexo'] == 'M') ? 'Estimado' : 'Estimada'); ?> <strong><?= $evaluador['nombre']; ?></strong>, le informamos que su Evaluado <strong><?= $evaluado['nombre']; ?></strong> el <?= formato_fecha_hora(date('Y-m-d H:i:s')); ?> ha solicitado la apelación de la evaluación y resultados de su Formulario EPPO del periodo <?= $periodo['periodo'] ?>. El Comité de Evaluación, según corresponda, debe re evaluar el Formulario dentro de los plazos establecidos en la Guía EPPO.</p>
                                    ...
                                    <table style="border-collapse: collapse; width: 100%;">
                                        <tbody>
                                            <tr style="color: #FFF; background-color: #f28b2f;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">COMENTARIOS DEL EVALUADO</td> 
                                            </tr>
                                            <tr style="background: #fcf8e3;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= nl2br($apelacion); ?></td>
                                            </tr>
                                        </tbody> 
                                    </table>  
                                    ...
                                    <p style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left;">Este mensaje ha sido enviado al Comité de Evaluación y a todos los Evaluadores asignados al Evaluado en el periodo <?= $periodo['periodo']; ?>.</p>
                                    <br />
                                  </th>
