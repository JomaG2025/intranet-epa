        	...
        	<div class="panel panel-default no-border">
				...
				<div class="panel-body">
			        <div class="row">
			        	<div class="col-lg-12">
                            <form method="post" action="<?= site_url('admin/etapas/grabar'); ?>" enctype="multipart/form-data">
				                <fieldset>
								    <legend>Nueva Etapa</legend>
								    <div class="row">
								        <div class="col-md-6">
                                            <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="puedeevaluar" value="1" /> Evaluarse
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="puedeapelar" value="1" /> Apelarse
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
