        	...
        	<div class="panel panel-default no-border">
				...
				<div class="panel-body">
			        <div class="row">
			        	<div class="col-lg-12">
                            <form method="post" action="<?= site_url('admin/periodos/grabar'); ?>" enctype="multipart/form-data">
				                <fieldset>
								    ...
								    <div class="row">
								        <div class="col-md-2 col-md-offset-4">	
                                            <div class="form-group">
                                                <label>Periodo</label>
												<input type="number" name="periodo" class="form-control" min="2005" max="2030" value="<?= date('Y'); ?>" autofocus required />
								            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <div class="input-group">
                                                      <input type="number" min="1" max="99" class="form-control" name="ponderacionobjetivoarea" />
                                                ...
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <div class="input-group">
                                                      <input type="number" min="1" max="99" class="form-control" name="ponderacionobjetivoindividual" />
                                                      <div class="input-group-addon">%</div>
                                                    </div>
                                                </div>
                                            </div>
