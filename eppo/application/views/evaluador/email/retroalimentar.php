                                      ...
                                      <tbody>
                                        <tr style="padding: 0; text-align: left; vertical-align: top;">
                                          <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                            <p class="text-right" style="Margin: 0; Margin-bottom: 10px; color: #fff; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; padding-top: 15px; text-align: right;">EVALUACIÓN EPPO</p>
                                          </th>
                                        </tr>
                                      </tbody>
                                    </table>
                          ...
                          <th class="small-12 large-12 columns first last" style="Margin: 0 auto; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0 auto; padding: 0; padding-bottom: 16px; padding-left: 16px; padding-right: 16px; text-align: left; width: 564px;">
                            <table style="border-collapse: collapse; border-spacing: 0; padding: 0; text-align: left; vertical-align: top; width: 100%;">
                              <tbody>
                                <tr style="padding: 0; text-align: left; vertical-align: top;">
                                  <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                    <h1 style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 34px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left; word-wrap: normal;">Su Formulario EPPO <?= $periodo['periodo']; ?> ha recibido una retroalimentación
                                    <p style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left;"><?= (($evaluado['sexo'] == 'M') ? 'Estimado' : 'Estimada'); ?> <strong><?= $evaluado['nombre']; ?></strong>, le informamos que el <?= formato_fecha_hora(date('Y-m-d H:i:s')); ?> su Evaluador ha retroalimentado <?php if($tipoitem == 'objetivoarea'){ ?>un <strong>OBJETIVO DE ÁREA</strong><?php } ?><?php if($tipoitem == 'objetivoindividual'){ ?>un <strong>OBJETIVO INDIVIDUAL</strong><?php } ?><?php if($tipoitem == 'capacitacion'){ ?>una <strong>SUGERENCIA DE CAPACITACIÓN</strong><?php } ?> de su Formulario EPPO del periodo <?= $periodo['periodo'] ?>.</p>
                                        
                                    <p style="Margin: 0; Margin-bottom: 10px; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0;">&nbsp;</p>
                                             
                                    <?php if($tipoitem == 'objetivoarea'){ ?>
                                        
                                    <table style="border-collapse: collapse; width: 100%;">
                                        <tbody>
                                            <tr style="color: #FFF; background-color: #2980b9;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">PROYECTO</td>
                                            </tr>
                                            <tr style="background: #B2DFF5;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= $item['proyecto']; ?></td>
                                            </tr>
                                            
                                            <tr style="color: #FFF; background-color: #2980b9;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">DESCRIPCIÓN</td>
                                            </tr>
                                            <tr style="background: #B2DFF5;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= $item['descripcion']; ?></td>
                                            </tr>
                                            
                                            <tr style="color: #FFF; background-color: #2980b9;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">OBJETIVO</td>
                                            </tr>
                                            <tr style="background: #B2DFF5;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= $item['objetivo']; ?></td>
                                            </tr>
                                            
                                            <tr style="color: #FFF; background-color: #2980b9;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">META</td>
                                            </tr>
                                            <tr style="background: #B2DFF5;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= $item['meta']; ?></td>
                                            </tr>
                                            
                                            <tr style="color: #FFF; background-color: #2980b9;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">INDICADOR</td>
                                            </tr>
                                            <tr style="background: #B2DFF5;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= $item['indicador']; ?></td>
                                            </tr>
                                            
                                            <tr style="color: #FFF; background-color: #2980b9;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">PLAN</td>
                                            </tr>
                                            <tr style="background: #B2DFF5;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= $item['plan']; ?></td>
                                            </tr>
                                    ...
                                    <?php if($tipoitem == 'objetivoindividual'){ ?>
                                        
                                    <table style="border-collapse: collapse; width: 100%;">
                                        <tbody>                                    
                                            <tr style="color: #FFF; background-color: #2980b9;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">DIMENSIÓN</td>
                                            </tr>
                                            <tr style="background: #B2DFF5;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= $item['dimension']; ?></td>
                                            </tr>
                                    ...
                                    <?php if($tipoitem == 'capacitacion'){ ?>
                                        
                                    <table style="border-collapse: collapse; width: 100%;">
                                        <tbody>                                    
                                            <tr style="color: #FFF; background-color: #2980b9;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">SUGERENCIA DE CAPACITACIÓN</td>
                                            </tr>
                                            <tr style="background: #B2DFF5;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= $item['descripcion']; ?></td>
                                            </tr>
                                    ...
                                    <table style="border-collapse: collapse; width: 100%;">
                                        <tbody>
                                            <tr style="color: #FFF; background-color: #f28b2f;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; padding-left: 4px; text-align: left; vertical-align: middle; font-weight: bold;">RETROALIMENTACIÓN</td> 
                                            </tr>
                                            <tr style="background: #fcf8e3;">
                                                <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;"><?= nl2br($retroalimentacion); ?></td>
                                            </tr>
                                        </tbody> 
                                    </table>
                                    ...
                                    <p style="Margin: 0; Margin-top: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left;">Para ingresar al Sistema de Evaluación EPPO, debe realizarlo a través de la Intranet EPA en el siguiente link <a href="http://intranet.puertoarica.cl">http://intranet.puertoarica.cl</a>.</p>
                                    <br />
                                  </th>
