                                      ...
                                      <tbody>
                                        <tr style="padding: 0; text-align: left; vertical-align: top;">
                                          <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                            <p class="text-right" style="Margin: 0; Margin-bottom: 10px; color: #fff; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; padding-top: 15px; text-align: right;">CONTRATOS</p>
                                          </th>
                                        </tr>
                                      </tbody>
                                    </table>
                          ...
                          <th class="small-12 large-12 columns first last" style="Margin: 0 auto; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0 auto; padding: 0; padding-bottom: 16px; padding-left: 16px; padding-right: 16px; text-align: left; width: 564px;">
                            <table style="border-collapse: collapse; border-spacing: 0; padding: 0; text-align: left; vertical-align: top; width: 100%;">
                              <tbody>
                                <tr style="padding: 0; text-align: left; vertical-align: top;">
                                  <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                    <h1 style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 34px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left; word-wrap: normal;">Informe semanal de Contratos alertados</h1>
                                    <p style="Margin: 0; Margin-bottom: 10px; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; margin-bottom: 10px; padding: 0; text-align: left;"><?= (($usuario['sexo'] == 'M') ? 'Estimado' : 'Estimada'); ?> <strong><?= $usuario['nombre']; ?></strong>, a continuación se presenta el detalle de los Contratos que al día de hoy se encuentran Alertados y/o Vencidos, según la información y plazos registrados en el Módulo de Control de Contratos con terceros.</p>
                                    <br>
                                  </th>
                                  ...
                                  <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                    ...
                                    <table style="border-collapse: collapse; width: 100%;">
								        <thead style="color: #FFF; background-color: #2980b9;">
								            <tr>
								                <th style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; text-align: center; vertical-align: middle; font-weight: bold;">ID</th>
                                                <th style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; text-align: center; vertical-align: middle; font-weight: bold;">RUT</th>
                                                <th style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; text-align: center; vertical-align: middle; font-weight: bold;">RAZON SOCIAL</th>
                                                <th style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; text-align: center; vertical-align: middle; font-weight: bold;">INICIO</th>
                                                <th style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; text-align: center; vertical-align: middle; font-weight: bold;">TERMINO</th>
                                                <th style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; text-align: center; vertical-align: middle; font-weight: bold;">GLOSA</th>
                                                <th style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; text-align: center; vertical-align: middle; font-weight: bold;">DÍAS</th>
                                                <th style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; border-right: solid 1px #FFF; padding-bottom: 5px; text-align: center; vertical-align: middle; font-weight: bold;">ESTADO</th>
								            </tr>
								        </thead>
								        <tbody>
                                            ...
                                            <?php foreach($contratos as $contrato){
                                                ...
                                                $fin  = new DateTime($contrato['termino']);
                                                $diff = $hoy->diff($fin);
                                                if ($fin >= $hoy) {
                                                    $dias_texto = $diff->days . ' día(s)';
                                                    $dias_color = ($diff->days <= 7) ? '#c0392b' : '#e67e22';
                                                    $fila_bg    = '#fef9e7';
                                                } else {
                                                    $dias_texto = 'Hace ' . $diff->days . ' día(s)';
                                                    $dias_color = '#c0392b';
                                                    $fila_bg    = '#fadadd';
                                                }
                                            ?>

                                                <tr style="background: <?= $fila_bg; ?>; padding: 0; text-align: left; vertical-align: top;">
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: center; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                                        <?= $contrato['id']; ?>
                                                    </td>
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: center; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                                        <?= formato_monto($contrato['proveedor']); ?>-<?= $contrato['proveedor_dv']; ?>
                                                    </td>
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: center; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                                        <?= $contrato['proveedor_razon']; ?>
                                                    </td>
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: center; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                                        <?= $contrato['inicio']; ?>
                                                    </td>
                                                    ...
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: left; font-size: 11px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                                        <?= $contrato['glosa']; ?>
                                                    </td>
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: center; font-size: 12px; color: <?= $dias_color; ?>; font-weight: bold; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                                        <?= $dias_texto; ?>
                                                    </td>
                                                    <td style="font-family: Helvetica, Arial, sans-serif; text-align: center; font-size: 12px; color: #333333; vertical-align: middle; padding: 5px; border-right: solid 1px #FFF; border-bottom: solid 1px #FFF;">
                                  ...
                                  <th class="small-5 large-5 columns first" style="Margin: 0 auto; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0 auto; padding: 0; padding-bottom: 16px; padding-left: 16px; padding-right: 8px; text-align: left; width: 225.66667px;">
                                    <table style="border-collapse: collapse; border-spacing: 0; padding: 0; text-align: left; vertical-align: top; width: 100%;">
                                      <tbody>
                                        <tr style="padding: 0; text-align: left; vertical-align: top;">
                                          <th style="Margin: 0; color: #333333; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; line-height: 1.3; margin: 0; padding: 0; text-align: left;">
                                            <img src="http://puertoarica.cl/graficas/imagenes/logo-default.png" alt="" style="-ms-interpolation-mode: bicubic; clear: both; display: block; max-width: 100%; outline: none; text-decoration: none; width: auto;">
                                          </th>
                                        </tr>
                                      </tbody>
                                    </table>
