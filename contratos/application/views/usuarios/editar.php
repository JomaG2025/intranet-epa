				...
				<div class="panel-body">
			        ...
			        <div class="row">
			        	...
			        	<div class="col-lg-12">
							    ...
							    <form method="post" action="<?= site_url('usuarios/actualizar'); ?>" enctype="multipart/form-data">
								    	...
								    	<div class="row">
										    ...
										    <div class="col-md-6">	
												<div class="form-group">
													<label>Usuario</label>
													<input type="text" disabled="disabled" value="<?= $usuario['usuario']; ?>"  class="form-control" />										
												</div>         					    
									        </div>
